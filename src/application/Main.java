    ...
    public static void main(String[] args) {
        ...
        while(!gameInstance.isGameOver()) {
            ...
            // If no cards are playable, draw a card from deck
                ...
                System.out.println("No cards in player " + currentPlayer + "'s hand are playable. Drew a new card. " + currentPlayerHand.size() + " cards remaining.");
            ...
            // --- GAME STEP 3. Play the card at cardIndex (or not play, if no playable card exists) ---
            if (cardIndex != -1) {
