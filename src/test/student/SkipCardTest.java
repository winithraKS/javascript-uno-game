...
public class SkipCardTest {
    ...
    void testCanPlay() {
        ...
        BaseCard topCard = gameInstance.getTopCard();
        assertTrue(c1.canPlay());  //color matches
        gameInstance.setTopCard(c1);
        assertTrue(c4.canPlay());  //color and symbol matches
        gameInstance.setTopCard(c4);
        assertTrue(c3.canPlay());  //symbol matches
        gameInstance.setTopCard(c3);
        assertFalse(c5.canPlay());  //not match anything
    }
